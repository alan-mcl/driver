...
public final class VehicleSpreadsheetSchema {
    ...
    private static final List<SpreadsheetColumn> COLUMNS = List.of(
            ...
            col("pricing.listPrice", ColumnType.DOUBLE),
            col("pricing.dealerOffer", ColumnType.DOUBLE),
            col("pricing.listPriceDate", ColumnType.DATE),
            col("pricing.dealerOfferDate", ColumnType.DATE),
            ...
            col("manualScoreOverrides.reliabilityManualEstimate", ColumnType.DOUBLE),
            col("derivedMetrics.reliabilityHeuristic", ColumnType.DOUBLE),
            col("derivedMetrics.reliabilityScore", ColumnType.DOUBLE),
            col("manualScoreOverrides.prestigeScore", ColumnType.DOUBLE),
